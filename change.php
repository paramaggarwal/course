...
if(isset($_POST['Submit']))
{
	...
	if($newvalue != "")
	{
		$result = mysql_query("UPDATE `login_table` SET `$index` = '$newvalue' WHERE `user_name` = '$username' LIMIT 1 ;");
	...
	header("Location: http://localhost/secure/changeprofile.php?change=Y");
}
?>
